...
public class MyListener implements ServletContextListener{
	...
	try{
		...
		PreparedStatement ps3=con.prepareStatement("CREATE SEQUENCE kingbomm MINVALUE 1 MAXVALUE 999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE");
		ps3.executeUpdate();
	    ...
	    ps4.setString(1,"kingbomm");
		ps4.setString(2,"mantu");
		...
		ps5.setString(1,"kingbomm");
		ps5.setString(2,"mantu");
		ps5.executeUpdate();
